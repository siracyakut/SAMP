...
new oduller[][] =
{
	...
	{"650 Skor Paketi"},
	{"1000 Skor Paketi"},
	{"Günlük EXP Bonus Ýtem"},
	{"Günlük Ganimet Koruma Ýtem"},
	{"2'li Renk Paketi"},
	{"2'li Dövüþ Paketi"},
	{"1 Jetpack"},
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	switch(dialogid)
	{
	    ...
	    case 1236:
	    {
	        ...
	        format(str, sizeof(str), "{008c23}<{c0c0c0}(?){008c23}> Kutudan '{c0c0c0}%s{008c23}' kazandýnýz!", oduller[odul_id][0]);
...
CMD:paket(playerid, params[])
{
	...
	strcat(str, "{0027e7}===========================================================================\n");
	strcat(str, "{0027e7}Küçük Þanslý Paket Açýlýmý\n");
	strcat(str, "{0027e7}===========================================================================\n");
	...
	strcat(str, "{0027e7}===========================================================================\n");
	strcat(str, "{00a882}(?) Eðer sahip olduðunuz süreli eþyalardan biri gelirse mevcut eþyanýn süresi otomatik uzatýlýr.\n");
	strcat(str, "{00a882}(?) Eðer sahip olduðunuz sýnýrsýz eþyalardan biri gelirse eþya yerine +10 TIFKredi hesabýnýza eklenir.\n");
	ShowPlayerDialog(playerid, 1234, DIALOG_STYLE_MSGBOX, "TurkIbiza™ Freeroam", str, "AÇ", "Ýptal");
	return true;
}
